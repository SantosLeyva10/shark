<?php if ( ! function_exists( 'matraman_lite_comment' ) ) :

function matraman_lite_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			<header class="clearfix">
                ...
                <?php printf( __( '%s', 'matraman-lite' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
                </div><!-- .comment-author .vcard -->
                
				<?php if ( $comment->comment_approved == '0' ) : ?>
                	<div class="waiting-moderation">
					<em><?php _e( 'Your comment is awaiting moderation.', 'matraman-lite' ); ?></em>
					</div>
				<?php endif; ?>
				...
				said on
					...
					<?php printf( _x( '%1$s', '1: date', 'matraman-lite' ), get_comment_date()); ?>
					</time>
				</div><!-- .comment-meta .commentmetadata -->
               

                <div class="comment-action">
            	<span class="edit-comment-link"><?php edit_comment_link( __( 'Edit', 'matraman-lite' ), '<span class="edit-link">', '<span>' ); ?></span>
...
function matraman_lite_comment_form(){
